...
layui.define(["element","jquery","session"],function(exports){
    ...
    Tab.prototype.navBar = function(strData){
        ...
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].children != undefined && data[i].children.length > 0){
                ...
                ulHtml += '&nbsp&nbsp<cite>'+data[i].title+'</cite>';
                ...
                for(var j=0;j<data[i].children.length;j++){
                    ...
                    ulHtml += '&nbsp&nbsp<cite>'+data[i].children[j].title+'</cite></a></dd>';
                }
                ulHtml += "</dl>";
            }else{
                ...
                ulHtml += '&nbsp&nbsp<cite>'+data[i].title+'</cite></a>';
            }
            ulHtml += '</li>';
        }
        return ulHtml;
	...
	Tab.prototype.render = function() {
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a data-url="page/sys/main.html"><i class="layui-icon" data-icon=""></i>&nbsp&nbsp<cite>后台首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-210);
